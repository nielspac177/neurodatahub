...
STRINGS = {
    "en": {
        ...
        "cv_open": "Open question",
        "cv_well-studied": "Well-studied",
        "cv_note_open": "A genuine clinical uncertainty a neurosurgeon reviewer judged still open.",
        "cv_note_well-studied": "A sound learnable project, but the question is largely settled by existing trials — good for learning method and checking your answer against the literature.",
        "m_datasets": "datasets",
    ...
    "es": {
        ...
        "cv_open": "Pregunta abierta",
        "cv_well-studied": "Muy estudiada",
        "cv_note_open": "Una incertidumbre clínica real que un neurocirujano revisor consideró todavía abierta.",
        "cv_note_well-studied": "Un proyecto sólido para aprender, pero la pregunta ya está en gran parte resuelta por ensayos — útil para aprender el método y contrastar tu resultado con la literatura.",
